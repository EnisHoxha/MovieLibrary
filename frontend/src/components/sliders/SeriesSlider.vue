...
const getMovies = async () => {
  await axios
    .get(`${host}/api/movies/typeMovie?type=Series`, { withCredentials: true })
    .then((res) => {
...
<template>
  <section class="md:p-12 p-6 ">
    <h1 class="md:text-4xl font-medium dark:text-white border-l-4 border-yellow-500 my-2 pl-2">Watch Tv Shows</h1>
